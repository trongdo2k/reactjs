...
function Infor(){
   ...
   const minmax=()=>{
    ...
    return (
        <div>
            <img src={Susan_smith[count].avatar} alt="" />
            <br/>
            name: {Susan_smith[count].name} 
            <br/>
            job: {Susan_smith[count].job}
            <br/>
            comment: {Susan_smith[count].content}
            <br/>
            <button id="btlastpage" onClick={decrement} type="submit">last</button>
            <button id="btnextpage" onClick={increment} type="submit">next</button>
        </div>
    )
}
function App(){
